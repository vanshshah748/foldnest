...
function processFiles($dir, $isRoot) {
    ...
    foreach ($files as $file) {
        ...
        // Ensure UTF-8 BOM is removed if present to prevent parsing issues
        ...
        // Fix any mangled copyright or emojis
        $newContent = str_replace(['Â©', 'ðŸŒ“', '??', 'c 2026'], ['©', '🌙', '🌙', '© 2026'], $newContent);
