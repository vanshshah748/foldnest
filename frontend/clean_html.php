...
function processFiles($dir, $isRoot) {
    ...
    foreach ($files as $file) {
        ...
        // Fix footers
        $newContent = preg_replace('/AÂ?c\s*2026|Ac\s*2026/', '© 2026', $newContent);
        $newContent = preg_replace('/Aï¿½sA1/', '₹', $newContent);
        $newContent = preg_replace('/Aï¿½,ï¿½\?ï¿½\?T/', '🔒', $newContent);
